            ...
            <table class="table table-hover table-striped">
                ...
                <tbody id="circulationTable">
                    ...
                    <tr class="circulation-row" 
                        ...
                        <td>
                            <button type="button" class="btn btn-sm btn-success restore-btn" data-id="<?= $circ['id'] ?>" title="Restore">
            ...
            iziToast.question({
                ...
                buttons: [
                    ['<button>OK</button>', function(instance, toast) {
                        ...
                        window.location.href = '<?= site_url("library/circulation/restore/") ?>' + circulationId;
                    }, true],
